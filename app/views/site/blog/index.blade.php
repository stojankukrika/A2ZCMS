...
<div class="post">
	<div class="row">
		<div class="span3">
			<a href="{{{ $blog->url() }}}"> <img class="main_pic" alt="main pic" src="http://placehold.it/260x180" /> </a>
		</div>
		<div class="span4 info">
			<a href="{{{ $blog->url() }}}"> <h3>{{ String::title($blog->title) }}</h3> </a>
			<p>
	...
	<a href="{{{ $blog->url() }}}#blogcomments" class="btn"> {{$blog->blogcomments->count()}}
