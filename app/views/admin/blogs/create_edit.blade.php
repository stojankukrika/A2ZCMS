...
@section('content')
	<!-- Tabs -->
		<ul class="nav nav-tabs">
			...
			<li class=""><a href="#tab-meta-data" data-toggle="tab">Meta data</a></li>
			<li class=""><a href="#tab-dates" data-toggle="tab">Publish dates</a></li>
		</ul>
	<!-- ./ tabs -->
			...
			<div class="tab-pane" id="tab-meta-data">
				...
				<div class="form-group {{{ $errors->has('meta-title') ? 'error' : '' }}}">
					<div class="col-md-12">
						...
						<input class="form-control" type="text" name="meta-title" id="meta-title" value="{{{ Input::old('meta-title', isset($blog) ? $blog->meta_title : null) }}}" />
				...
				<div class="form-group {{{ $errors->has('meta-description') ? 'error' : '' }}}">
					<div class="col-md-12 controls">
						...
						<input class="form-control" type="text" name="meta-description" id="meta-description" value="{{{ Input::old('meta-description', isset($blog) ? $blog->meta_description : null) }}}" />
				...
				<div class="form-group {{{ $errors->has('meta-keywords') ? 'error' : '' }}}">
					<div class="col-md-12">
						...
						<input class="form-control" type="text" name="meta-keywords" id="meta-keywords" value="{{{ Input::old('meta-keywords', isset($blog) ? $blog->meta_keywords : null) }}}" />
